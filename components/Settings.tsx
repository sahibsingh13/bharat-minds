...
export default function Settings() {
  ...
  return (
    <div>
      <button onClick={() => setOpen(true)} className="text-sm px-4 py-2 rounded-xl border-2 border-white/20 bg-gradient-to-r from-blue-500/10 to-purple-500/10 hover:from-blue-500/20 hover:to-purple-500/20 hover:border-white/30 transition-all duration-200">⚙️ Settings</button>
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-2xl border-2 border-white/10 bg-gradient-to-b from-gray-900 to-gray-800 text-white p-6 shadow-2xl">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <a
                ...
                className="text-xs px-3 py-1.5 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 text-white border border-blue-400/20 hover:from-blue-600 hover:to-purple-700 transition-all duration-200"
              >
                Get API key
              </a>
            </div>
            ...
            <div className="flex gap-3 justify-end mt-6">
              <button onClick={() => setOpen(false)} className="px-4 py-2 rounded-xl bg-white/10 border-2 border-white/20 hover:bg-white/20 transition-colors">Close</button>
              <button onClick={save} className="px-4 py-2 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white border border-blue-400/20 transition-all duration-200">Save</button>
            </div>
          </div>
        </div>
      )}

      ...
      {MODEL_CATALOG.map((m: AiModel) => {
        ...
        return (
          <button
            ...
            className={`px-2 py-1 rounded-lg border text-xs tracking-tight ${selected ? 'bg-blue-500 border-blue-500/50 text-white' : 'bg-gray-100 border-gray-300 text-gray-700'} ${disabled ? 'opacity-40 cursor-not-allowed' : 'hover:bg-gray-200'}`}
